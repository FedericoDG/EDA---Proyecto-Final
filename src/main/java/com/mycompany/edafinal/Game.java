...
public class Game {
   ...
   *
   * @return Un número entero que representa el éxito o no del movimiento (1:
   * Bien, 2: Mal, 3: Prohibido avanzar, 5: Tesoro encontrado)
   */
   ...
   *
   * @return El número 4 que representa que el jugador ha vuelto a la casilla
   * anterior.
   */
  ...
  /**
   * Imprime por pantalla el el árbol de nodos que representa al juego,
   * indicando la posición actual del jugador
   *
   */
  public void showMap() {
